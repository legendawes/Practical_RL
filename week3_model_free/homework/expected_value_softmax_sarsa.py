...
class EVSoftmaxSarsaAgent():
  ...
  """
  def __init__(self,alpha,tau,discount,getLegalActions):
...
#---------------------#start of your code#---------------------#
  ...
  def getValue(self, state):
    ...
    probs = self.softmax(qValues / tau)

    value = np.sum(np.multiply(qValues, probs))
    return value
...
#     print()
    ...
    best_action = np.random.choice(possibleActions, p=probs)
    return best_action
